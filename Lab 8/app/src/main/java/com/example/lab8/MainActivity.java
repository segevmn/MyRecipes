...
public class MainActivity extends AppCompatActivity implements CountryFragment.CountryListener, CountryDetailsFragment.CountryDetailsListener, CountryAdapter.ItemClickListener {
    @Override
